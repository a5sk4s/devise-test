...
function chkPass(pwd) {
	...
	/* Modify overall score value based on usage vs requirements */
		...
		oScorebar.style.backgroundPosition = "-" + parseInt(nScore * 3.6) + "px 0";
...
function initPwdChk(restart) {
	...
	document.getElementById("scorebar").style.backgroundPosition = "0 0";
	if (restart) {
		document.getElementById("user_password").className = "";
	}
}
